%
%        SYNTHETIC EXPERIMENT FOR CONSTRAINED k-CHAIN LASSO
%
% Regularized problem for chain latent group Lasso 
%
%       min_x |Dx-y| s.t. chain_lgl(x) \leq rho
%
...
param.method='asqp';
tic
[x_sol, ActiveSet, hist, iter] = cgan_lgl_constrained(D,y,param);
cg_x=x_sol;
cg_dg=hist.dg;
cg_tt=hist.tt;
...
title('duality gap chain lgl constrained');
