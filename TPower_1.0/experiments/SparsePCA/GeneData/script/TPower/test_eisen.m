...
% save results
TPower_Result_eisen = [];
TPower_Result_eisen.CPUTime = t_cpu;
TPower_Result_eisen.variance_rate = vars/trace(A);
TPower_Result_eisen.cardinality_path = cardinality_path;
save ..\..\result\TPower_Result_eisen.mat 'TPower_Result_eisen';
