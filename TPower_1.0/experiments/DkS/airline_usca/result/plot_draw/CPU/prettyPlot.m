function [] = prettyPlot(xData,yData,legendStr,plotTitle,plotXlabel,plotYlabel,type, epsname, style,errors)
...
set(gca,'FontName','times','FontWeight','normal','FontSize',15);
...
set([h1 h2],'FontName','times','FontSize',20,'FontWeight','normal');
