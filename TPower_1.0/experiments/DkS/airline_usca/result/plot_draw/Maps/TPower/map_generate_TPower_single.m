clear all;
load('..\..\..\..\data\data_city');
load('..\..\..\TPower_Single_Result.mat');

dense_subgraph_idx_mul = TPower_Single_Result.dense_subgraph_idx;
center_city_idx_mul = TPower_Single_Result.center_city_idx;
...
print('-depsc2', 'TPower_single.eps');
