...
%% -------------------------------- TPower for finding multiple DkS -------------------------------
W = ( W + W' )/2;
dim = size(W,1);
...
% Save results
TPower_Multiple_Result = [];
TPower_Multiple_Result.cardinality = cardinality_sequence;
TPower_Multiple_Result.dense_subgraph_idx = dense_subgraph_idx_mul;
TPower_Multiple_Result.center_city_idx = center_city_idx_mul;

save ..\..\result\TPower_Multiple_Result.mat 'TPower_Multiple_Result';
