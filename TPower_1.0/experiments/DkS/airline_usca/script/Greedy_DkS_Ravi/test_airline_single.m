...
%% -------------------------------- Greedy-Ravi for finding single DkS -------------------------------
...
Greedy_Ravi_Single_Result = [];
Greedy_Ravi_Single_Result.cardinality = cardinality_sequence;
Greedy_Ravi_Single_Result.dense_subgraph_idx = dense_subgraph_idx_mul;
Greedy_Ravi_Single_Result.center_city_idx = center_city_idx_mul;

save ..\..\result\Greedy_Ravi_Single_Result.mat 'Greedy_Ravi_Single_Result';
