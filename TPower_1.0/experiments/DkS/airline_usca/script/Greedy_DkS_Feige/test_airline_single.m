...
% Save results
Greedy_Feige_Single_Result = [];
Greedy_Feige_Single_Result.cardinality = cardinality_sequence;
Greedy_Feige_Single_Result.dense_subgraph_idx = dense_subgraph_idx_mul;
Greedy_Feige_Single_Result.center_city_idx = center_city_idx_mul;

save ..\..\result\Greedy_Feige_Single_Result.mat 'Greedy_Feige_Single_Result';
